...
import * as worldbookEntryCompatibilityFieldsMigration from "./0007_worldbook_entry_compatibility_fields.js";
...
const migrations: Record<string, DialectMigration> = {
  ...
  "0007_worldbook_entry_compatibility_fields": {
    common: worldbookEntryCompatibilityFieldsMigration,
  },
};
