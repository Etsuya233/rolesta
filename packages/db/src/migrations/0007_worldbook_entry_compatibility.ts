...
export async function up(db: Kysely<Database>): Promise<void> {
  await db.schema
    ...
    .addColumn("selective_logic", "varchar(32)", (column) =>
  ...
  await db.schema
    .alterTable("worldbook_entries")
    .addColumn("exclude_recursion", "integer", (column) =>
      column.notNull().defaultTo(0),
    )
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .addColumn("prevent_recursion", "integer", (column) =>
      column.notNull().defaultTo(0),
    )
    .execute();
  await db.schema
  ...
  await db.schema
    .alterTable("worldbook_entries")
    .addColumn("insertion_role", "varchar(32)", (column) =>
      column.notNull().defaultTo("system"),
    )
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .addColumn("anchor_name", "text", (column) =>
...
export async function down(db: Kysely<Database>): Promise<void> {
  ...
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("anchor_name")
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("insertion_role")
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("delay_until_recursion")
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("prevent_recursion")
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("exclude_recursion")
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("entry_scan_depth")
    .execute();
  await db.schema
    .alterTable("worldbook_entries")
    .dropColumn("selective_logic")
    .execute();
}
