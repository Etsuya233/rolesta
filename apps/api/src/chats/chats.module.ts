...
import { KyselyChatAssetAccess } from "./persistence/kysely-chat-asset-access.js";
...
@Module({
  ...
  providers: [
    KyselyChatStore,
    KyselyChatAssetAccess,
    CryptoIdGenerator,
    SystemClock,
    AssetVisibilityEventsListener,
    { provide: CHAT_STORE, useExisting: KyselyChatStore },
    { provide: CHAT_ASSET_ACCESS, useExisting: KyselyChatAssetAccess },
    {
