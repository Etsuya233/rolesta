...
import type { ChatClock, ChatIdGenerator } from './application/chat-application-services.js';
...
import { CHAT_ASSET_ACCESS, type ChatAssetAccess } from './ports/chat-asset-access.js';
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      inject: [CHAT_STORE, CHAT_ASSET_ACCESS, CryptoIdGenerator, SystemClock, UNIT_OF_WORK],
    },
    {
