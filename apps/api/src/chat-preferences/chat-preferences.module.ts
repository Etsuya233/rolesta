...
import { CHAT_ASSET_OWNERSHIP, type ChatAssetOwnership } from './ports/chat-asset-ownership.js';
...
@Module({
  ...
  providers: [
    ...
    AssetDeletedEventsListener,
    {
      ...
      useFactory: (store: AssetDefaultsStore) => new GetAssetDefaultsUseCase(store),
