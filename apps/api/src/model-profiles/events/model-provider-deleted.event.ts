...
export class ModelProviderDeletedEvent implements DomainEvent<typeof MODEL_PROVIDER_DELETED> {
  readonly type = MODEL_PROVIDER_DELETED;
  readonly modelProviderId: string;
  readonly ownerUserId: string;
  readonly occurredAtMs: number;

  constructor(options: { modelProviderId: string; ownerUserId: string; occurredAtMs: number }) {
