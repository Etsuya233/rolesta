...
import { CHARACTER_REFERENCE_ACCESS } from './contracts/character-reference-access.js';
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      inject: [CHARACTER_CARD_STORE, SystemClock, UNIT_OF_WORK, DomainEventPublisher],
    },
    {
      ...
      useFactory: (
        ...
        unitOfWork: UnitOfWork,
        events: DomainEventPublisher,
      ) => new UploadCharacterAvatarUseCase(store, avatars, assignment, clock, unitOfWork, events),
      inject: [
    ...
    },
    {
      ...
      useFactory: (
        ...
        unitOfWork: UnitOfWork,
        events: DomainEventPublisher,
      ) => new DeleteCharacterAvatarUseCase(assignment, avatars, clock, unitOfWork, events),
      inject: [
        CHARACTER_AVATAR_ASSIGNMENT,
        CHARACTER_AVATAR_SERVICE,
        SystemClock,
