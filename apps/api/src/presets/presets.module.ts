...
import type { PresetClock, PresetIdGenerator } from './application/preset-application-services.js';
...
@Module({
  ...
  providers: [
    ...
    },
    {
      ...
      ) => new CreatePresetUseCase(store, idGenerator, clock, modelProviderAccess, unitOfWork),
      inject: [
        PRESET_STORE,
        CryptoIdGenerator,
        SystemClock,
    ...
    },
    {
      ...
      ) => new UpdatePresetUseCase(store, clock, modelProviderAccess, unitOfWork, events),
      inject: [
        PRESET_STORE,
        SystemClock,
        PRESET_MODEL_PROVIDER_ACCESS,
    ...
    },
    {
      ...
      useFactory: (
        ...
        unitOfWork: UnitOfWork,
        events: DomainEventPublisher,
      ) => new UpdatePresetDocumentUseCase(store, clock, modelProviderAccess, unitOfWork, events),
      inject: [
        PRESET_STORE,
        SystemClock,
        PRESET_MODEL_PROVIDER_ACCESS,
    ...
    },
    {
      ...
      inject: [PRESET_STORE, PRESET_CODEC, CryptoIdGenerator, SystemClock, UNIT_OF_WORK],
    },
    {
      provide: ExportPresetUseCase,
      useFactory: (store: PresetStore, codec: PresetCodec) => new ExportPresetUseCase(store, codec),
    ...
    },
    {
      ...
      useFactory: (store: PresetStore, clock: PresetClock, unitOfWork: UnitOfWork) =>
