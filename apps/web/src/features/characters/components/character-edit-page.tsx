...
export function CharacterEditPage({ page, onBack, pushPage }: CharacterEditPageProps) {
  ...
  return (
    <CharacterStackPage>
      ...
      <CharacterCardMainEditor
        ...
        onOpenGreetings={() => pushPage(alternateGreetingsPage(page.characterId, page.sessionKey))}
      />
    </CharacterStackPage>
  );
}
