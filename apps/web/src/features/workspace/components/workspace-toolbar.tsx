...
import { workspacePanelDefinitions, type WorkspacePanelKey } from '../model/workspace-panels';
...
export function WorkspaceToolbar({
  ...
  const toolbarButtonClassName = 'active:not-aria-[haspopup]:translate-y-0';
